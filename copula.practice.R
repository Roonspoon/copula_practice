...
## This is an example of how to fit a copula in R, found at
...
# Elliptical and Archimedean copulas have nice mathematical 
# proprieties, shape and formulas. This is how you would 
# generate a bivariate normal and t copula with known parameters
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Since the Gaussian copula results from taking a multivariate 
# normal and transforming the margins to uniformity, a 
# multivariate distribution with Gaussian copula and normal 
# margins is multivariate normal? 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# So in our case this is not the same? Because the marginals
# are not normal, they will be a Schechter/double Schecher,
# right? Also - what about how Schechter fit changes with the 
# transformation to L Phi(L)? Should be simply multiplying by L
# ... Right?
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# 
